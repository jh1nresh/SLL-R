  ...
  return {
    ...
    evaluator: {
      ...
      checks: [
        ...
        "merchant marked fulfillment or customer claim was recorded",
...
export function sllrManifest(origin: string) {
  return {
    ...
    endpoints: {
      ...
      merchantOffers: `${origin}/merchants/{merchantId}/offers`,
      merchantCapacity: `${origin}/merchants/{merchantId}/capacity`,
      merchantBatches: `${origin}/merchants/{merchantId}/batches`,
    ...
    capabilities: [
      ...
      "Level 1 fixed merchant offers",
      "Level 2 independent-order fulfillment batches",
      "Level 3 atomic pickup capacity windows",
      "checkout handoff",
    ...
    tools: [
      ...
      {
        name: "list_merchant_offers",
        method: "GET",
        path: "/merchants/{merchantId}/offers",
        description: "List fixed merchant-backed offers that use the normal quote and consent path.",
      },
      {
        name: "quote_merchant_offer",
        method: "POST",
        path: "/merchants/{merchantId}/offers/{offerId}/quote",
        description: "Quote one exact offer, optionally for a requested pickup time.",
      },
      {
        name: "list_merchant_capacity",
        method: "GET",
        path: "/merchants/{merchantId}/capacity",
        description: "Read atomic 15-minute pickup capacity windows by production class.",
      },
      {
        name: "create_fulfillment_batch",
        method: "POST",
        path: "/merchants/{merchantId}/batches",
        description: "Group independently paid, same-window orders for merchant fulfillment.",
      },
      {
        name: "list_fulfillment_batches",
        method: "GET",
        path: "/merchants/{merchantId}/batches",
        description: "List merchant fulfillment batches without merging child order identity.",
      },
      {
        name: "get_fulfillment_batch",
        method: "GET",
        path: "/merchants/{merchantId}/batches/{batchId}",
        description: "Read one fulfillment batch and the aggregate state of its child orders.",
      },
      {
      ...
      },
      {
        ...
        description: "Record Base MCP request or transaction id as payment proof; fulfillment is still required for final receipt memory.",
      },
      {
